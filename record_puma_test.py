#!/usr/bin/env python3
"""
Script to record Puma test execution and organize files for video-analysis-agent
"""
...
class PumaTestRecorder:
    def __init__(self, project_dir="/Users/anup/Desktop/Anup/project/testzeus-hercules"):
        self.project_dir = Path(project_dir)
        self.input_file = "opt/input/puma_search.feature"
        self.output_dir = self.project_dir / "video-analysis-agent" / "puma_test_inputs"
        
    def setup_environment(self):
        """Set up environment variables for video recording"""
        print("Step 1: Configuring environment for video recording...")
        os.environ['RECORD_VIDEO'] = 'true'
        os.environ['HEADLESS'] = 'false'
        os.environ['TAKE_SCREENSHOTS'] = 'true'
        os.environ['CAPTURE_NETWORK'] = 'true'
        print("✓ Environment configured")
    
    def cleanup_previous_runs(self):
        """Clean up previous test outputs"""
        print("\nStep 2: Cleaning up previous test outputs...")
        # Note: Keeping previous runs for reference, just note them
        print("✓ Ready for new test run")
    
    def run_test(self):
        """Execute the Puma test"""
        print("\nStep 3: Running Puma test with video recording...")
    ...
    def copy_files(self, latest_run):
        ...
        planning_log_src = (
            ...
            "Search_for_Palermo_on_Puma_India" / latest_run / "agent_inner_thoughts.json"
        )
        ...
        test_result_src = (
            ...
            "puma_search.feature_result.xml"
        )
        ...
        video_dir = (
            ...
            "Search_for_Palermo_on_Puma_India" / latest_run / "videos"
        )
        ...
        if video_dir.exists():
            ...
            if video_files:
                ...
                print(f"✓ Copied video.webm ({video_src.stat().st_size:,} bytes)")
    ...
    def display_summary(self, files_copied):
        ...
        if len(files_copied) == 3:
            ...
            print("    --planning-log puma_test_inputs/planning_log.json \\")
            print("    --video puma_test_inputs/video.webm \\")
            print("    --test-output puma_test_inputs/test_result.xml \\")
            print("    --output-dir puma_test_inputs/results")
        else:
    ...
    def record(self):
        ...
        print("\n" + "="*60)
        print("Puma Test Recording Script")
        print("="*60 + "\n")
        ...
        return len(files_copied) == 3

def main():
    recorder = PumaTestRecorder()
